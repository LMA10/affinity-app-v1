    ...
    >
      ...
      <div
        className={cn(
          ...
          side === "left"
            ? "left-0 group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1_+_30px)]"
            : "right-0 group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1_+_30px)]",
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[state=collapsed]:ml-[0px]",
        className,
      )}
      {...props}
    />
