...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "text-[16px] font-semibold leading-none tracking-tight font-['Helvetica','Arial',sans-serif] text-white [&_button:disabled]:bg-[#0C2027] [&_button:disabled]:border [&_button:disabled]:border-[#849DA6]",
      className
    )}
    {...props}
  />
