      ...
      <div className="flex h-full w-full relative">
        ...
        {isOpen && selectedAlert && (
          <>
            ...
            <div
              className="fixed z-50 top-0 right-0 h-screen w-full md:w-[400px] bg-[#C7CDCF] border border-[#506C77] flex flex-col space-y-4 overflow-hidden transition-all duration-300 block md:block"
            >
